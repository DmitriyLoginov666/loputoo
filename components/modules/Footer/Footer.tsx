      ...
      <div className='footer__top'>
        <div className='container footer__top__container'>
          ...
          <div className='footer__contacts'>
            <span>
              <a href='tel:+37257888738'>+37257888738</a>
            </span>
            <span>
              <a href='mailto:dmitriy.loginov@ivkhk.ee'>
                dmitriy.loginov@ivkhk.ee
              </a>
            </span>
          ...
          <ul className='list-reset footer__socials'>
            <li className='footer__socials__item'>
              <a href='#' className='footer__socials__item__link' />
            </li>
            <li className='footer__socials__item'>
              <a
                href='https://vk.com'
